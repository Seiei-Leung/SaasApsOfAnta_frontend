  ...
  <div id="productionPlanningSetting-component">
    <div class="productionPlanningSettingWrapper rightBlockTabpaneWrapper" ref="rightBlockTabpaneWrapper">
        <div v-show="!isShowSettingBlock">
          <Table :height="msgOfCSS.heightOfTable" :loading="sumTableLoading" border :columns="sumTableTitle" :data="sumTableData" ></Table>
...
export default {
    data: function() {
        return {
            ...
            inputsah: 0,
            inputapproveTime: "",
            inputembroiderDaynum: 0,
            inputstyle: "",
            inputembroiderTime: "",
            inputfactoryEmbroider: "",
            inputbackpartDaynum: 0,
            inputmemo: "",
            inputcuttingqty: 0,
            inputisFinishCutting: "",
            inputadvancecuttingDaynum: 0,
            inputColor: "",
            inputSizes: "",
            inputorderkind: "",
    ...
    computed: {
        msgOfCSS: function() {
            return {
                heightOfTable: this.windowHeight - CONST.cssData.pageHeaderHeight - CONST.cssData.containerPageTabHeight - 200, // 110 为分页控件及多余空隙的高度
            }
        }
    }
}
